...
const char* OTA_HOSTNAME = "biome2-lakeshore";
const char* MQTT_BROKER  = "192.168.8.228";
const int   MQTT_PORT    = 1883;
const char* MQTT_CLIENT  = "biome2-lakeshore";

const char* TOPIC_TELEMETRY = "miniBIOTA/biome/2/telemetry";
const char* TOPIC_STATUS    = "miniBIOTA/biome/2/status";
const char* TOPIC_SETPOINT  = "miniBIOTA/biome/2/setpoint";
...
// ---------------------------
// MQTT callback — setpoint updates TARGET_TEMP_C, window stays 5°C
// ---------------------------
...
void loop() {
  ...
  if (now - lastUpdate >= UPDATE_INTERVAL) {
    ...
    displayBiome.print(F("LAKESHORE         "));
