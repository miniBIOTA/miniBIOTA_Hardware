...
- Biome SHT31-D appears physically water damaged and crusted; likely burned out.
- Atmosphere side is currently working.
- Atmosphere humidity display shows a partial extra digit or display artifact under the small percent symbol.
- Root causes are not fully isolated. Current suspects include SDA/SCL twisted-pair wiring, general connection quality, and water-damaged SHT31 modules.
