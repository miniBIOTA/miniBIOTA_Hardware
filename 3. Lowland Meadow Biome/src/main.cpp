...
const char* OTA_HOSTNAME = "biome3-meadow";
const char* MQTT_BROKER  = "192.168.8.228";
const int   MQTT_PORT    = 1883;
const char* MQTT_CLIENT  = "biome3-meadow";

const char* TOPIC_TELEMETRY = "miniBIOTA/biome/3/telemetry";
const char* TOPIC_STATUS    = "miniBIOTA/biome/3/status";
const char* TOPIC_SETPOINT  = "miniBIOTA/biome/3/setpoint";
...
void loop() {
  ...
  if (now - lastUpdate >= UPDATE_INTERVAL) {
    ...
    displayBiome.print(F("LOWLAND MEADOW    "));
