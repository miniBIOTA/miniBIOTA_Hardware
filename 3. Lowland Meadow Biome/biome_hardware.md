...
- Atmosphere OLED shows `Sensor Err` over the SHT31-D data.
- Atmosphere SHT31-D appears to provide low-quality or unstable data.
- Atmosphere humidity reads 100% and does not change; this may indicate sensor damage.
