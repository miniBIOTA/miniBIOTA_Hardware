...
const char* OTA_HOSTNAME = "biome5-marine";
const char* MQTT_BROKER  = "192.168.8.228";
const int   MQTT_PORT    = 1883;
const char* MQTT_CLIENT  = "biome5-marine";

const char* TOPIC_TELEMETRY = "miniBIOTA/biome/5/telemetry";
const char* TOPIC_STATUS    = "miniBIOTA/biome/5/status";
const char* TOPIC_SETPOINT  = "miniBIOTA/biome/5/setpoint";
...
void loop() {
  ...
  if (now - lastUpdate >= UPDATE_INTERVAL) {
    ...
    displayBiome.print(F("MARINE SHORE      "));
