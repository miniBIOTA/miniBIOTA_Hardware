...
- Biome 5 appears to be working.
- One humidity display shows a partial extra digit or display artifact under the small percent symbol.
- Rewire and sensor replacement pass is still pending because the current shared wiring approach has known signal-quality risk.
